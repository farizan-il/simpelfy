...
<div class="container-xxl flex-grow-1 container-p-y">         
    <!-- Hour chart  -->
    @if ($jumlahKelasWajib > 0)
        <div class="alert alert-danger alert-dismissible p-4" role="alert">
            Anda masih mempunyai kelas wajib yang harus diikuti sebanyak {{ $jumlahKelasWajib }} kelas | <span class="underline"><a href="/kelaswajib">belajar sekarang</a></span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
            </button>
        </div>
    @else
        <div class="alert alert-success alert-dismissible" role="alert">
            <h4 class="alert-heading d-flex align-items-center"><span class="alert-icon rounded-circle"><i class="bx bx-coffee"></i></span>Selamat, {{ Auth::user()->profile->nama }}!</h4>
            <hr>
            <p class="mb-0">
                Luar biasa! Anda telah menyelesaikan semua kelas wajib. Jangan berhenti di sini – jelajahi kelas lainnya dan tingkatkan skor Anda untuk menjadi yang terbaik!
            </p>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
            </button>
        </div>
    @endif
    <div class="card bg-transparent shadow-none my-1 border-0">
        <div class="row">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="card-icon">
                                <span class="badge bg-label-success rounded p-2">
                                    {{-- <i class='{{ $perubahan >= 0 ? 'bx bx-trending-up bx-sm' : 'bx bx-trending-down bx-sm' }}'></i> --}}
          ...
          plotOptions: {
            radialBar: {
              ...
              track: {
                strokeWidth: '18',
                background: '#e0e0e0',
                strokeDashArray: 5 // Make the track dashed
              }
            }
          },
          labels: ['Memiliki 22 ⭐']
