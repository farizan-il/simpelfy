...
class BerandaController extends Controller
{
    public function index()
    {
        ...
        // LOGIKA MENGAMBIL DATA KARYAWAN DARI DATABASE
        $dataKaryawan = UserProfile::with('role')
            ->where('role_id', '48f2740e-7f3a-11ef-abce-334bdb6c896b')
            ->get();
        return view('gondowangi.frontend.beranda.index', [
     ...
     */
    public function getDashboardData($employeeId)
    {
        $userId = Auth::id();
        $currentMonth = Carbon::now()->format('Y-m');
        ...
        return view('gondowangi.frontend.beranda.partials.dashboard-data', [
            'pengeluaranBulanIni' => $pengeluaranBulanIni,
            'perubahan' => $perubahan,
            'totalPengeluaran' => $totalPengeluaran,
            'bulan' => $bulan,
